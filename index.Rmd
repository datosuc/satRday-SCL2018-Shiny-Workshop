...
- La aplicación debe mostgrar a travéz de un gráfio la variación del indicador
respecto al tiempo.
...
Enviar a más tardar el martes 10 de noviembre el script y el link de la aplicación
al correo con el asunto **Evaluación shiny Sección B** Indicando en el cuerpo del mail
